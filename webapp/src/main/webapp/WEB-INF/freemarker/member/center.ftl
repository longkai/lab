...
<#--更新成员信息modal-->
<div id="update_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    ...
    <div class="modal-body">
        <form class="form-horizontal">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea type="text" class="description" name="description" placeholder="个人介绍"></textarea>
                </div>
            </div>
        </form>
    </div>
...
<#--更新app信息modal-->
<div id="app_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 class="title"></h3>
    </div>
    <div class="modal-body">
        <form class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="os_requirement" name="os_requirement" placeholder="系统要求" />
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="outside_link" name="outside_link" placeholder="外链（可选）" />
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea type="text" class="description" name="description" placeholder="描述"></textarea>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="extra">额外信息（可选）</label>
                ...
                <div class="controls">
                    <textarea type="text" class="extra" name="extra" placeholder="额外信息（可选）"></textarea>
                </div>
            </div>
        </form>
    </div>
...
<#--更新版本信息modal-->
<div id="update_version_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 class="title"></h3>
    ...
    <div class="modal-body">
        <form class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea type="text" class="update_info" name="update_info" placeholder="更新信息"></textarea>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="extra">额外信息（可选）</label>
    ...
    $(function () {
        ...
        $('#create-icon').fineUploader({
            ...
            'error': function(event, id, fileName, responseJSON) {
                if (!responseJSON.success) {
                   $('#icon_alert').append('<div class="alert alter-error lead">' + responseJSON.msg + '</div>')
                }
            }
        });
        ...
        $('#update').click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!data.member.id) {
                        alert(data.msg || '查找成员信息失败！请联系管理员！');
                        return;
                    }
                    var m = data.member;
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status === 1) {
                        ...
                        alert(data.msg || '修改失败！请稍后再试或者联系管理员！');
                    }
                }
            });
        })
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        $('<div/>').addClass('alert text-error').text('添加失败！' + data.msg);
                    }
                }
            })
        })
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        alert('修改失败！' + data.msg + (data.reason ? data.reason : ""));
                    }
                }
            })
        });
