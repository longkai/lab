...
<div class="container" id="meta-data">
    ...
    <div class="app">
        ...
        <div>
            <a class="btn btn-success" id="download" href="/apps/${app.id}/download/${version.id}"><span class="glyphicon glyphicon-download-alt"></span> 下载</a>
        </div>
    </div>
</div>
    ...
    <div class="panel">
        ...
        <ul class="list-group" id="comments">
            ...
            <li class="list-group-item">
                <button class="btn btn-success btn-block" appid="${app.id}" id="more_comments">查看更多</button>
            </li>
        </ul>
    </div>
</div>
...
<div class="modal fade" id="comment_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btnClose" data-dismiss="modal">取消</button>
                ...
                <div class="container" style="margin-top: 10px">
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item">
                            ...
                            <p class="list-group-item-text" id="_description">${member.description}</p>
                        </a>
                    </div>
                </div>
            </div>
