...
import cn.newgxu.extras.UploadPath;
...
import cn.newgxu.lab.store.service.AppService;
import cn.newgxu.lab.store.service.CommentService;
import cn.newgxu.lab.support.member.Member;
...
//        appService.create(app, version);
	...
	@ResponseBody
	public String createIcon(HttpServletRequest request, @RequestPart("icon") MultipartFile icon) {
