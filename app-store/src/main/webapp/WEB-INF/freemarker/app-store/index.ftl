			...
			<div class="col-lg-3">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<a href="/apps/${a.id}" class="btn btn-primary view_app">查看</a> <a
							href="/apps/${a.id}/download" class="btn btn-default">下载</a>
						<#switch a.platform>
							<#case 'ANDROID'>
								<img src="/r/app-store/android.png" alt="android"
									 class="pull-right" />
								<#break />
							<#case 'APPLE'>
								...
								<#break />
							<#case 'WINDOWS'>
								<img src="/r/app-store/windows.png" alt="apple"
									 class="pull-right" />
								<#break />
						</#switch>
						</p>
...
<div class="modal fade" id="participate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	 aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="container" style="margin-top: 10px">
					<form class="form-horizontal" role="form" id="sync_form">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="个人标签" class="form-control" name="label" id="label"
									   placeholder="几个关键词！" />
							</div>
						</div>
						<div class="form-group">
