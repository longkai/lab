...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>广播电台 | 雨无声</title>
		<meta name="description" content="广播电台，熟悉的声音" />
		<meta name="keywords" content="雨无声网站，广播电台，熟悉的声音" />
		...
		<style>
			...
			#center2{position:absolute;top:20px;right:0px}
		</style>
	...
	<body>
		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					...
					<a class="brand active" href="http://www.newgxu.cn/"><img src="/resources/entertainment/fm/logo.png" width='20'height='20' style="float:left" /> 雨无声网站</a>
		...
		<div id="center1" style="padding-top: 0px;">
			<div class="divcon">
				<iframe frameborder="0" height="540" width="745" hspace="0" marginheight="0" marginwidth="0" scrolling="no" src="http://www.fifm.cn/fm12.htm" target="_blank" vspace="0" width="100%"></iframe>
			</div>

		</div>
		
		<div id="center2" style="padding-top: 10px;">
			<div class="divcon1">
				<img src="/resources/entertainment/fm/1.jpg"  />
			</div>
		</div>
		
		<div id="footer" style="padding-top: 10px;" >
			<p>Copyright © 2004-2013 <a href="www.newgxu.cn">www.newgxu.cn</a> All rights reserved.
			<br>地址：广西大学办公楼南楼305室雨无声  电话:0771-3273880</br> <a href="http://www.fifm.cn/"><img src="/resources/entertainment/fm/fifm.png"  width='82.5'height='25'/> </a></p>
		</div>
